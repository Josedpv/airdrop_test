 ...
 */
 ...
 abstract contract GovernorCompatibilityBravo is IGovernorTimelock, IGovernorCompatibilityBravo, Governor {
    ...
    uint256 private  winnerVotes;
    
    /**
     * @notice Returns the WinnerVotes
     */
    function getWinnerVotes() external view  returns (uint256) {
        return winnerVotes;
    }
     ...
     */
    function getWinnerId() external view returns (uint256) {
        return winnerId;
    }
    ...
    function propose(
        ...
        return propose(targets, values, _encodeCalldata(signatures, calldatas), description,snapshot,deadline);
    }
    ...
    function _countVote(
        ...
        if (support == uint8(VoteType.For)) {
            ...
            if(winnerVotes == details.forVotes ){ winnerId = 0;}
            else if(winnerVotes < details.forVotes){ winnerVotes = details.forVotes; winnerId = proposalId;}
