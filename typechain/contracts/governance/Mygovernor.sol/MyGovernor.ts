...
export interface MyGovernorInterface extends utils.Interface {
  functions: {
    ...
    "extend_deadline(uint256)": FunctionFragment;
    ...
    "getWinnerId()": FunctionFragment;
    "getWinnerVotes()": FunctionFragment;
    ...
    "propose(address[],uint256[],string[],bytes[],string,uint64,uint64)": FunctionFragment;
    "propose(address[],uint256[],bytes[],string,uint64,uint64)": FunctionFragment;
    ...
    "start_deadline()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "proposalThreshold"
      | "proposals"
      | "propose(address[],uint256[],string[],bytes[],string,uint64,uint64)"
      | "propose(address[],uint256[],bytes[],string,uint64,uint64)"
  ...
  encodeFunctionData(
    functionFragment: "extend_deadline",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getWinnerId",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getWinnerVotes",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "propose(address[],uint256[],string[],bytes[],string,uint64,uint64)",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<string>[],
  ...
  encodeFunctionData(
    functionFragment: "propose(address[],uint256[],bytes[],string,uint64,uint64)",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<BytesLike>[],
  ...
  encodeFunctionData(
    functionFragment: "start_deadline",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MyGovernor extends BaseContract {
  ...
  functions: {
    ...
    getWinnerId(overrides?: CallOverrides): Promise<[BigNumber]>;

    getWinnerVotes(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    start_deadline(overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    getWinnerId(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getWinnerVotes(overrides?: CallOverrides): Promise<PopulatedTransaction>;
