...
export interface IOptionalOnlyCallerInterface extends utils.Interface {
  functions: {
...
export interface IOptionalOnlyCaller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOptionalOnlyCallerInterface;
